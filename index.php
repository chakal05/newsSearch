...
if (array_key_exists('abonner', $_POST)){
  ...
  $to = $email;
    ...
    $message = ' Le parti RPP se réjouit de votre abonnement à notre Newsletter.
   Nous vous invitons chaleureusement à rejoindre notre mouvement en adhérant au parti.
   Bienvenue !
    ';
...
<p><i class="fas fa-check"></i> Nous poursuivons une croissance économique constante.</p>
   ...
   <a class="rond" href="missions.php" >Missions</a>
    ...
    <a href='https://twitter.com/RPP_Officiel' target='_blank'><i class='fab fa-twitter-square'></i></a>
    <a href='https://www.facebook.com/RPP.OFFICIEL' target='_blank'><i class="fab fa-facebook-square"></i></a>
    </div>
    </div>
